...
urlpatterns = [
    ...
    path('pdo_subject_table_remove/<int:id>/', views.pdo_subject_table_remove, name='pdo_subject_table_remove'),
    path('pdo_subject_table_add', views.pdo_subject_table_add, name='pdo_subject_table_add'),
    path('teacher_edit/<int:id>/', views.teacher_edit, name='teacher_edit'),
    path('pdo_teacher_edit/<int:id>/', views.pdo_teacher_edit, name='pdo_teacher_edit'),
    path('admin_edit', views.admin_edit, name='admin_edit'),
    path('statistics_def', views.statistics_def, name='statistics_def'),
    path('pdo_table', views.pdo_table, name='pdo_table'),
    ...
    path('pdo_teacher_table_remove/<int:id>', views.pdo_teacher_table_remove, name='pdo_teacher_table_remove'),
    path('pdo_teacher_table_add/<int:id>', views.pdo_teacher_table_add, name='pdo_teacher_table_add'),
